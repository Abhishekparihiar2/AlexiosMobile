...
export default function CertificationDetailScreen({ cert, onBack }: Props) {
    return (
        <div
            style={{
                display: "flex",
            ...
            <div style={{ padding: "8px 16px" }}>
                <div style={{
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: "8px", marginTop: "4px", flexWrap: "wrap" }}>
                        <div style={{
                            background: cert.expiringColor.replace("1)", "0.1)"),
                            border: `1px solid ${cert.expiringColor.replace("1)", "0.3)")}`,
                            color: cert.expiringColor,
                            padding: "4px 10px", borderRadius: "8px", fontSize: "11px", fontWeight: 700, fontFamily: "Inter, sans-serif",
                    ...
                    <div style={{ color: "rgba(255,255,255,0.7)", fontSize: "13px", fontFamily: "Inter, sans-serif", lineHeight: 1.5 }}>
                        This certification verifies that the employee has completed required training for {cert.name}. Ensure it remains updated to comply with current regulations.
                    </div>
                </div>
            </div>
