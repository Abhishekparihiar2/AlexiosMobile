...
import FloorSelector from "./map/FloorSelector"
import ThreeDViewport from "./map/ThreeDViewport"
import AssetLegend from "./map/AssetLegend"
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Viewport wrapper (relative so FloorSelector can be absolutely positioned) */}
        ...
        {/* Asset legend */}
        <AssetLegend active={activeFilter} onChange={setActiveFilter} />
          ...
          {[
            {
              ...
              value: "12",
              color: "#4DD9E8",
              bg: "rgba(77,217,232,0.07)",
              border: "rgba(77,217,232,0.18)",
            },
            {
              label: "Fire Panels",
              value: "4",
