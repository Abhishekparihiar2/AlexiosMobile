import WarningBanner from "./sitestatus/WarningBanner"
import AthenaInsightCard from "./sitestatus/AthenaInsightCard"
import TelemetryGrid from "./sitestatus/TelemetryGrid"

interface Props {
  onBack: () => void
}

export default function SiteStatusScreen({ onBack }: Props) {
  return (
    <div
      style={{
        width: "393px",
